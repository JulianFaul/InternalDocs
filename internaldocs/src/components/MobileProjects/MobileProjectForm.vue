<template>
    ...
    <v-form class='form' v-on:submit.prevent>
        <button @click='onSubmit' :class='buttonText.replace( /\s/g, "").toLowerCase() + " button button__blue"' >{{buttonText}}</button>
        ...
        <div class='form-section'>
            ...
            <div class='form-section__details'>
                <v-text-field  label="App Title"></v-text-field>
                <v-text-field  label="App Subtitle"></v-text-field>
            ...
            <div class='form-section__platforms'>
                    <div class='form-section__platform'>
                        ...
                        <span v-if='payload.appLive'>
                            <v-text-field class='form-section__textfield' label="Live Link"></v-text-field>
                    ...
                    <div class='form-section__platform'>
                        ...
                        <span v-if='payload.appDemo'>
                            <v-text-field class='form-section__textfield' label="Demo Link"></v-text-field>
                    ...
                    <div class='form-section__platform'>
                        ...
                        <span v-if='payload.appStaging'>
                            <v-text-field class='form-section__textfield' label="Staging Link"></v-text-field>
                    ...
                    <div class='form-section__platform'>
                        <v-checkbox @change="onCheckboxChange" class='form-section__checkbox' label='Devel' v-model='payload.appDevel'></v-checkbox>
                         <span v-if='payload.appDevel'>
                            <v-text-field class='form-section__textfield' label="Devel Link"></v-text-field>
...
export default {
    ...
    data () {
        return {
            ...
            develDate: null,
            payload: {
                appVersion:  this.project.appVersion,
                country:     this.project.country,
                appType:     this.project.appType,
                priority:    this.project.priority,
                productType: this.project.productType,
                appLive:     this.project.appLive,
                appDemo:     this.project.appDemo,
                appStaging:  this.project.appStaging,
                appDevel:    this.project.appDevel,
                liveDate:    this.project.liveDate,
                demoDate:    this.project.demoDate,
                stagingDate: this.project.stagingDate,
                develDate:   this.project.develDate,
                milestone:   this.project.milestone,
                appStatus:   this.project.appStatus
            }
        }
    },
    methods:{
